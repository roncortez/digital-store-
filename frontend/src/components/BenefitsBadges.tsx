    ...
    <div className="pt-8 border-t border-gray-100">
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center group">
          <div className="w-10 h-10 mx-auto bg-brand-dark rounded-full flex items-center justify-center mb-2 group-hover:bg-brand-yellow/20 transition-colors">
        ...
        <div className="text-center group">
          <div className="w-10 h-10 mx-auto bg-brand-dark rounded-full flex items-center justify-center mb-2 group-hover:bg-brand-yellow/10 transition-colors">
            <svg className="w-5 h-5 text-brand-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
